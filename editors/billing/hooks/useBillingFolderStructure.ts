...
export interface UseBillingFolderStructureResult {
  ...
  /** Create a new month folder with a Payments subfolder */
  ...
  const createMonthFolder = useCallback(
    async (monthName: string) => {
      ...
      try {
        ...
        // Create Payments subfolder. Unlike contributor-billing, no Reporting
        // subfolder is created -- this app has no reports. The read side still
        // CLASSIFIES Reporting folders so drives created by the old app render
        // correctly.
